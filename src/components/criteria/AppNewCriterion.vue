            ...
            <div class="row">
                <div class="col-md">
                    <b-form-group label="Criterion Title" label-for="newCriterionTitle">
                        <b-form-input required placeholder="Criterion Title" v-model="form.title" type="text" id="newCriterionTitle"></b-form-input>
                    </b-form-group>
                </div>
                <div class="col-md">
                    <b-form-group label="Criterion Points" label-for="newCriterionPoints">
                        <b-form-input number placeholder="Criterion Points" required v-model="form.points" type="number" id="newCriterionPoints"></b-form-input>
                    </b-form-group>
                </div>
            </div>
            <b-form-group label="Criterion Guidelines" label-for="newCriterionGuideline">
                ...
                <b-form @submit="newGuideline">
                    <b-input-group>
                        ...
                        <b-form-textarea v-model="guidelineBuilder.ex" required placeholder="Noteworthy Examples and/or guidance" rows="3"
                                         no-resize></b-form-textarea>
