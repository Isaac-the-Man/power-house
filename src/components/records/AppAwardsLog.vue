                    ...
                    <b-form-group class="shadow">
                        <b-input-group prepend="Search">
                            <b-input-group-prepend>
                                <b-form-select v-model="filterField" :options="filterOptions" text-field="label" value-field="key"></b-form-select>
                            </b-input-group-prepend>
                            <b-form-input placeholder="filter" :disabled="filterField === null" v-model="filter" type="search"></b-form-input>
                        </b-input-group>
                    </b-form-group>
                </div>
                <div class="col">
